...
class MW_Pistol_G18C extends KFWeap_PistolBase;
...
defaultproperties
{
	...
	InstantHitDamage(DEFAULT_FIREMODE)=38 //37 //39 //41 // DEFAULT & ALT MODE DAMAGE DAMAGE
	...
	DualClass=class'MW_Pistol_DualG18' //Dual-wieldable yes
