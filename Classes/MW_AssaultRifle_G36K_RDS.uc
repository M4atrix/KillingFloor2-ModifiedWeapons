...
class MW_AssaultRifle_G36K_RDS extends KFWeap_AssaultRifle_G36C;
...
defaultproperties
{
	...
	// Zooming/Position
	IronSightPosition=(X=-6.0,Y=-9.3735,Z=1.6935) // (X=-4.48,Y=-9.3,Z=2.5)
	PlayerViewOffset=(X=3,Y=0,Z=0)

	// Content
	PackageKey="G36C"
	FirstPersonMeshName="WEP_1P_G36_V2_MESH.Wep_1stP_G36K_RDS_Rig"
	FirstPersonAnimSetNames(0)="WEP_1P_G36_V2_ANIM.Wep_1stP_G36K_Anim"
	PickupMeshName="WEP_3P_G36_V2_MESH.Wep_G36K_RDS_Pickup"
	AttachmentArchetypeName="WEP_G36_V2_ARCH.Wep_G36K_RDS_3P"
	...
	InstantHitDamage(DEFAULT_FIREMODE)=45.0 // 45.0
	...
	InstantHitDamage(ALTFIRE_FIREMODE)=45.0 // 45.0
