class MW_AssaultRifle_FNFalCM_2x extends KFWeap_RifleBase;
...
function SetOriginalValuesFromPickup(KFWeapon PickedUpWeapon)
{
	...
	ClientSetAltFire(MW_AssaultRifle_FNFalCM_2x(PickedUpWeapon).bIsAltFire);
}
...
DefaultProperties
{
	...
	InstantHitDamage(DEFAULT_FIREMODE)=65.0 //62
	...
	InstantHitDamageTypes(DEFAULT_FIREMODE)=class'KFDT_Ballistic_FNFal' //fal
	FireInterval(ALTFIRE_FIREMODE)=+0.0857 //700 RPM
	InstantHitDamage(ALTFIRE_FIREMODE)=65.0 //62 //60
