...
class MW_Shotgun_AA12 extends KFWeap_Shotgun_AA12;
...
simulated event SetWeapon()
{
	...
	if(GetPerk().class == class'KFPerk_Support')
	{
		...
		MinFiringPutDownPct = 0.70; // 0.80
		ReloadspeedMod = 0.95; //10% faster //5%
	}
}
...
defaultproperties
{
	...
	// Ammo
	MagazineCapacity[0]=32 //20
	SpareAmmoCapacity[0]=260 //120
